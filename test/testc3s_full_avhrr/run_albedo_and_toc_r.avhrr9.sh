...
echo "python3 ../.././pyal2/wrapper.py ../config/acf.c3s.avhrr_for_test.yaml ../config/pcf.c3s.avhrr.yaml --keywords name testname  site $site year 1988 --loglevel info --instruments AVHRR_NOAA9 --outputdates 1988-10-01,1988-11-01"
python3 ../.././pyal2/wrapper.py ../config/acf.c3s.avhrr_for_test.yaml ./pcf.c3s.avhrr.yaml --keywords name testname  site $site year '1988' --loglevel info --instruments AVHRR_NOAA9 --outputdates 1988-10-01,1988-11-01 1>log/$site/log.9 2>log/$site/logerr.9
...
do
    ...
    python3 ../../pyal2/wrapper_toc_r.py  -i $brdf -o $output 1>>log/$site/log.9 2>>log/$site/logerr.9
done
